...
if (isset($_POST['add_product'])) {
    if ($totalProducts >= 500) {
        ...
        $category = $_POST['category'] ?: $categories[0]; // default first-added category
...
if (isset($_POST['update_product'])) {
    ...
    $price = floatval($_POST['price']);
    $addedStock = intval($_POST['stock']); // amount to add
    ...
    $newStock = $cur_stock + $addedStock; // add to existing stock
...
<div class="content py-3"><!-- py-3 = padding top & bottom --><br>
    ...
    <div class="card shadow-sm py-0"><!-- py-3 = padding top & bottom sa card -->
