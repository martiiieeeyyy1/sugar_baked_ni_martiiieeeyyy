<?php
// ===================================================
// pos.php - Sugar Baked POS (Cashier) with 12% VAT & Void Feature
// ===================================================
...
if (!isset($_SESSION['role']) || strcasecmp(trim($_SESSION['role']), 'Cashier') !== 0) {
    header("Location: index.php");
    exit();
}
...
<head>
<meta charset="UTF-8">
<title>Sugar Baked POS - Cashier</title>
...
<div class="sidebar">
  ...
  <div class="sidebar-nav">
    ...
    <a href="pos.php" class="active"><i class="fas fa-cash-register"></i><span>POS</span></a>
...
<div class="pos-container">
  ...
  <div class="receipt">
    ...
    <form id="posForm" method="POST" action="pos.php">
...
document.getElementById('categorySelect').addEventListener('change', function() {
  ...
  const url = `pos.php?category=${encodeURIComponent(category)}&search=${encodeURIComponent(search)}`;
